# EyE Dual-License Agreement for [PROJECTNAME]
Copyright (c) 2025 Glurth. All rights reserved.

This copyright applies to the **[PROJECTNAME]** software package (the "Software"), including all source code, assets, and documentation.  
